                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $d['no_hp']; ?></td>
                                                <td><?= $d['tgl_masuk']; ?></td>
                                                <td><?= "Rp. " . number_format($d['pendaftaran'], 2, ',', '.');  ?></td>
                                                <td>
                                                    <?php
                                                    $pendaftaran = $d['pendaftaran'];
                                                    if ($pendaftaran == 0) {
                                                    ?>
                                            ...
                                            <form action="bayar.php?ket=pendaf" method="post" enctype="multipart/form-data">
                                                <div class="modal fade" id="modal-bayar<?php echo $d['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="exampleModalLabel">Bayar Pendaftaran Siswa</h4>
                                                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" name="id" required="required" class="form-control " placeholder="Masukkan Nama Siswa .." value="<?= $d['id']; ?>">
                                                                    <input type="hidden" name="pendaftaran" required="required" class="form-control " placeholder="Masukkan Nama Siswa .." value="<?= $d['pendaftaran']; ?>">
                                                                </div>
